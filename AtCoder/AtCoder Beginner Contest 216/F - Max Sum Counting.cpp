/*
	...
	name : F - Max Sum Counting.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/F_Max_Sum_Counting.cpp
	url : https://atcoder.jp/contests/abc216/tasks/abc216_f
*/
/**
 *    author:  Aryan Agarwal
 *    created: 29.08.2021 18:38:20 IST
**/
...
void solve()
{
	...
	vector< vector<mint> > dp(n+1,vector <mint> (5001));

	vector<mint> tot(5001);
	...
	for(int i=1;i<=n;i++){
		...
		for(int s=v[i].second;s<=5000;s++){

			dp[i][s]+=tot[s-v[i].second];
...
//	parsed : 29-August-2021 18:33:22 IST
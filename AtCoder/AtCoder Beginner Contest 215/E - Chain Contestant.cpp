/*
	...
	name : E - Chain Contestant.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/E_Chain_Contestant.cpp
	url : https://atcoder.jp/contests/abc215/tasks/abc215_e
*/
/**
 *    author:  Aryan Agarwal
 *    created: 21.08.2021 18:05:03 IST
**/
...
vector<vector<bool>> vis(1000,vector<bool>(1024,false));
vector<vector<mint>> val(1000,vector<mint>(1024));

int n;
string s;
mint dp(int i,int mask){

	if(vis[i][mask])return val[i][mask];
...
//	parsed : 21-August-2021 17:41:28 IST
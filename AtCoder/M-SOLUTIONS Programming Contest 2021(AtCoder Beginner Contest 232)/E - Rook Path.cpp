/*
	...
	name : E - Rook Path.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/E_Rook_Path.cpp
	url : https://atcoder.jp/contests/abc232/tasks/abc232_e
*/
/**
 *    author:  Aryan Agarwal
 *    created: 30.12.2021 13:57:47 IST
**/
...
void solve()
{
	...
	g[0][0]=1;
	while (k--){
		vector<vector<mint>> next(2,vector<mint>(2));
		next[0][0]=g[0][1]+g[1][0];
		next[0][1]=(w-1)*g[0][0] + (w-2)*g[0][1] + g[1][1];
		next[1][0]=(h-1)*g[0][0] + (h-2)*g[1][0] + g[1][1];
		next[1][1]=(h-1)*g[0][1] + (w-1)*g[1][0] + (h-2+w-2)*g[1][1];
		g=next;
	}
	long long a=0,b=0;
	long long s[2][2]={};
...
//	parsed : 30-December-2021 13:57:33 IST
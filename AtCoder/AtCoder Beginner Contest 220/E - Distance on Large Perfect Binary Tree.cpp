/*
	...
	name : E - Distance on Large Perfect Binary Tree.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/E_Distance_on_Large_Perfect_Binary_Tree.cpp
	url : https://atcoder.jp/contests/abc220/tasks/abc220_e
*/
/**
 *    author:  Aryan Agarwal
 *    created: 26.09.2021 18:35:35 IST
**/
...
mint f(int n,int d)
{
	...
	if(d>=2)
	{
		...
		if(2*l-d+1>0)
		{
			ans+=(2*l-d+1)*t.pow(d-2);
		}

	}

	return ans+2*f(n-1,d);
}

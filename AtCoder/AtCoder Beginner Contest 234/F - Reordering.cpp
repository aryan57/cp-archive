/*
	group : AtCoder - AtCoder Beginner Contest 234
	name : F - Reordering.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/F_Reordering.cpp
	url : https://atcoder.jp/contests/abc234/tasks/abc234_f
*/
/**
 *    author:  Aryan Agarwal
 *    created: 08.01.2022 18:35:07 IST
**/
...
void fact_init()
{
	...
	for (int i=2;i<=mxn;i++)
		inv_fact[i]=inv_fact[i-1]*((mint)1/i);
}
...
void solve()
{
	...
	mint ans=0;
	for(int len=1;len<=n;len++)ans+=dp[26][len];
	cout<<ans.val();
}
...
//	parsed : 08-January-2022 18:34:58 IST
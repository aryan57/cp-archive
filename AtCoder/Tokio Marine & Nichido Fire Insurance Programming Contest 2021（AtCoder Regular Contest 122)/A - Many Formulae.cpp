/*
	...
	name : A - Many Formulae.cpp
	srcPath : /home/aryan/Documents/cp/A_Many_Formulae.cpp
	url : https://atcoder.jp/contests/arc122/tasks/arc122_a
*/
/*
    author : aryan57
    created : 12-June-2021 18:17:22 IST
*/
...
void solve_LOG()
{
    ...
    F(i,2,n-1)
    {
        dp[i][0]+=dp[i-1][0] + cnt[i-1][0]*a[i];
        dp[i][0]+=dp[i-1][1] + cnt[i-1][1]*a[i];
        cnt[i][0]+=cnt[i-1][0]+cnt[i-1][1];
        
        dp[i][1]+=dp[i-1][0] - cnt[i-1][0]*a[i];
        cnt[i][1]+=cnt[i-1][0];

        // dbg(dp[i][0].val(),dp[i][1].val());
    }
...
//	parsed : 12-June-2021 18:17:11 IST
/*
	...
	name : Bunny Hops.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/Bunny_Hops.cpp
	url : https://www.codechef.com/LTIME99A/problems/BNYHOP
*/
/**
 *    author:  Aryan Agarwal
 *    created: 28.08.2021 19:58:37 IST
**/
...
bool comp(int u,int v){
	if(tin[u]!=tin[v])return tin[u]<tin[v];
...
void solve()
{
	...
	// segtree<mint,binary_operation,identity_element> t(n);
	mint ans=0;
	vector<mint> dp(n);
	for(int i=1;i<n;i++){
...
//	parsed : 28-August-2021 19:35:35 IST
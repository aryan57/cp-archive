/*
	...
	name : Projects.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/Projects.cpp
	url : https://cses.fi/problemset/task/1140
*/
/**
 *    author:  Aryan Agarwal
 *    created: 19.10.2021 21:33:03 IST
**/
#include <bits/stdc++.h>
using namespace std;
...
void solve()
{
	...
	for(int i=0;i<id;i++){
		int mx = 0;
		mx=max(mx,tree.prod(0,i));
		for(auto j : day[i]){
			int prev_profit = tree.prod(0,j.start);
			mx=max(mx,prev_profit+j.profit);
		}
		ans=max(ans,mx);
		tree.set(i,mx);
	}
...
//	parsed : 19-October-2021 21:32:57 IST
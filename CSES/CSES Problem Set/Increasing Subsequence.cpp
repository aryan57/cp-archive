/*
	...
	name : Increasing Subsequence.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/Increasing_Subsequence.cpp
	url : https://cses.fi/problemset/task/1145
*/
/**
 *    author:  Aryan Agarwal
 *    created: 19.10.2021 21:20:25 IST
**/
#include <bits/stdc++.h>
using namespace std;
...
int binary_operation(int a,int b){return max(a,b);}

int identity_element(){return 0;}
...
void solve()
{
	...
	segtree<int,binary_operation,identity_element> tree(id);
	int mx=1;
	for(int i=0;i<n;i++){
		int l = tree.prod(0,v[i]);
		tree.set(v[i],l+1);
		mx=max(mx,l+1);
	}
...
//	parsed : 19-October-2021 21:20:16 IST
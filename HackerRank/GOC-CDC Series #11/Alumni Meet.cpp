/*
	...
	name : Alumni Meet.cpp
	srcPath : /home/aryan/Documents/cp/Alumni_Meet.cpp
	url : https://www.hackerrank.com/contests/goc-cdc-series-11/challenges/alumni-meet
*/
/*
    author : aryan57
    created : 06-July-2021 13:10:01 IST
*/
#include <bits/stdc++.h>
using namespace std;
...
void solve_LOG()
{
    ...
    segtree<int,binary_operation,identity_element> tree(vector <int> (n,1));
    ...
    F(i,0,n-1)
    {
        ...
        int iden=v[i].Y;
        target=pos;
        int actual_pos = tree.max_right<check_function>(0);
        // dbg(pos,iden,actual_pos);
        ans[actual_pos]=iden;
        tree.set(actual_pos,0);
    }
...
//	parsed : 06-July-2021 11:03:30 IST
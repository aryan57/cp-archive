/*
	...
	name : E1. Rubik's Cube Coloring (easy version).cpp
	srcPath : /home/aryan/Desktop/cp-workspace/E1_Rubik_s_Cube_Coloring_easy_version_.cpp
	url : https://codeforces.com/contest/1594/problem/E1
*/
/**
 *    author:  Aryan Agarwal
 *    created: 08.10.2021 22:03:07 IST
**/
...
map<pair<int,char>,mint> val;

mint f(int k,char c)
{
	if(k==1)return 1;

	if(vis[{k,c}])return val[{k,c}];

	set<char> can={'w','r','g','b','o','y'};
	can.erase(c);
...
//	parsed : 08-October-2021 21:39:16 IST
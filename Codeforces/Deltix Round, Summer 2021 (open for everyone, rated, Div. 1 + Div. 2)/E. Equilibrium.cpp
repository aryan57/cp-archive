/*
	...
	name : E. Equilibrium.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/E_Equilibrium.cpp
	url : https://codeforces.com/contest/1556/problem/E
*/
/**
 *    author:  Aryan Agarwal
 *    created: 29.08.2021 23:37:42 IST
**/
#include <bits/stdc++.h>
using namespace std;
...
void solve()
{
	...
	segtree<int,o,e> mx(pre);
	segtree<int,o2,e2> mn(pre);
	...
	while(q--){
		...
		int mnn = mn.prod(l,r+1)-pre[l-1];
		int mxx = mx.prod(l,r+1)-pre[l-1];
...
//	parsed : 29-August-2021 23:37:29 IST
/*
	...
	name : D. Integers Have Friends.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/D_Integers_Have_Friends.cpp
...
void solve()
{
	...
	segtree<int,binary_operation,identity_element> tree(vv);
	int ans=1;

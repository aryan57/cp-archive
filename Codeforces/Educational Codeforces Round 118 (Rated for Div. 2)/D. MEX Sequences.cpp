/*
	...
	name : D. MEX Sequences.cpp
	srcPath : /home/aryan/Desktop/cp-workspace/D_MEX_Sequences.cpp
	url : https://codeforces.com/contest/1613/problem/D
*/
/**
 *    author:  Aryan Agarwal
 *    created: 01.12.2021 21:37:19 IST
**/
...
mint f4(vector <int> v)
{
	...
	for(int i=0;i<n;i++){
		...
		if(v[i]==0){
			dp[v[i]][0]=2*dp[v[i]][0]+1;
			dp[v[i]][1]=2*dp[v[i]][1]+1;
		}
		else{
			dp[v[i]][0]=2*dp[v[i]][0]+dp[v[i]-1][0];
			dp[v[i]][1]=2*dp[v[i]][1]+dp[v[i]-1][0];
		}
...
//	parsed : 01-December-2021 21:06:49 IST
...
bool iseqv(string s1,string s2,int sz1)
{
    // dbg(s1,s2);
    ...
    a1=s1.substr(0,sz1/2);
    b1=s2.substr(0,sz1/2);
    a2=s1.substr(sz1/2,sz1/2);
    b2=s2.substr(sz1/2,sz1/2);

    // dbg(a1,a2,b1,b2);

    // if(sz1==1 || sz2==1)cout<<"**";
    boo3=iseqv(a1,b2,sz1/2);
    if(boo3){if(iseqv(a2,b1,sz1/2))return 1;}

    boo1=iseqv(a1,b1,sz1/2);
    if(boo1){if(iseqv(a2,b2,sz1/2))return 1;}

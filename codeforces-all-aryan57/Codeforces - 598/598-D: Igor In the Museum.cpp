...
vector< vector <bool> >visited2 (1002, vector <bool> (1002,false));
vvi grid (1002, vi (1002,2));
vvi ans (1002, vi (1002,0));
...
void dfs(int x,int y,int *cnt)
{
    ...
    if(grid[x+1][y]==0 )*cnt= *cnt +1;
    if(grid[x-1][y]==0 )*cnt= *cnt +1;
    if(grid[x][y+1]==0 )*cnt= *cnt +1;
    if(grid[x][y-1]==0 )*cnt= *cnt +1;


    if(grid[x+1][y]==1 && !visited[x+1][y])dfs(x+1,y,cnt);
    if(grid[x-1][y]==1 && !visited[x-1][y])dfs(x-1,y,cnt);
    if(grid[x][y+1]==1 && !visited[x][y+1])dfs(x,y+1,cnt);
    if(grid[x][y-1]==1 && !visited[x][y-1])dfs(x,y-1,cnt);
}
...
void dfs2(int x,int y,int cnt)
{
    ...
    if(grid[x+1][y] && !visited2[x+1][y])dfs2(x+1,y,cnt);
    if(grid[x-1][y] && !visited2[x-1][y])dfs2(x-1,y,cnt);
    if(grid[x][y+1] && !visited2[x][y+1])dfs2(x,y+1,cnt);
    if(grid[x][y-1] && !visited2[x][y-1])dfs2(x,y-1,cnt);
}

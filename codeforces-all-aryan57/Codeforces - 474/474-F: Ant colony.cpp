...
/*
    author : aryan57
    created : 25-April-2021 15:57:31 IST
*/
#include <bits/stdc++.h>
using namespace std;
...
pair <int,int>  binary_operation_min(pair <int,int>  a,pair <int,int>  b)
{
    if(a.X<b.X)return a;
...
pair <int,int>  identity_element_min()
{
    return {INF,0};
}
...
int binary_operation_gcd(int a,int b)
{
    return gcd(a,b);
}

int identity_element_gcd()
{
    return 0;
}
...
void solve_LOG()
{
    ...
    segtree<pair <int,int> ,binary_operation_min,identity_element_min> tree1(n);
    segtree<int ,binary_operation_gcd,identity_element_gcd> tree2(n);
    ...
    while (q--)
    {
        ...
        auto p = tree1.prod(l,r+1);
        int g = tree2.prod(l,r+1);

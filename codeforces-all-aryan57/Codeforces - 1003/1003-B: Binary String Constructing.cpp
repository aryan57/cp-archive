...
#define in1(a, n) F(i, 1, n) \
                      cin >> a[i]
#define out(a, n) F(i, 0, n - 1) \
                      cout << a[i] << " "
#define out1(a, n) F(i, 1, n) \
                       cout << a[i] << " "
...
// freopen("input.txt","r",stdin);
    ...
    if (ans[0] == '0')
    {
        ...
        F(i,0,sz(ans)-1)
        {
            if(ans[i]=='1')
            {
                ans=ans.substr(0,i)+bb+ans.substr(i,sz(ans)-i);
                break;
            }
        }
    }
    else
    {
        ...
        F(i,0,sz(ans)-1)
        {
            if(ans[i]=='0')
            {
                ans=ans.substr(0,i)+aa+ans.substr(i,sz(ans)-i);
                break;
            }
        }
    }

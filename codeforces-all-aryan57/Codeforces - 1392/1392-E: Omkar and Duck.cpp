...
/*
    ...
    created : 17-August-2020 11:57:31 IST
    created : 17-August-2020 11:57:31-02:30:00 MSK
    // tutorial used after 0 attempts
    // credits : @errichto
*/
...
signed main()
{
    ...
    while (q--)
    {
        ...
        {
            if(row+1<n && grid[row+1][col]&k)
            {
                row++;
            }
            else if(col+1<n && grid[row][col+1]&k)
            {
                col++;
            }
            else
            {
                ...
                else if(col+1<n && grid[row][col+1]==0)
                {
                    col++;
                }
            }

...
void solve()
{
    int n0,n1,n2;
    cin>>n0>>n1>>n2;
    if(n0+n1+n2==n0){n0++;while(n0--)cout<<"0";return;}
    if(n0+n1+n2==n1){n1++;while(n1--){if(n1%2)cout<<"0";else cout<<"1";}return;}
    if(n0+n1+n2==n2){n2++;while(n2--)cout<<"1";return;}

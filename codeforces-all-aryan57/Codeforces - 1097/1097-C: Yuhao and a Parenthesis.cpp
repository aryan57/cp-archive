...
signed main()
{
    ...
    F(i,0,n-1)
    {
        ...
        F(j,0,sz(s[i])-1)
        {
            ...
            {
                if(q.empty()){valid[i]=0;break;}
                if(q.top()=='('){q.pop();continue;}
                valid[i]=0;break;
            }
        ...
        F(j,0,sz(s[i])-1)
        {
            ...
            {
                if(q2.empty()){temp++;continue;}
                if(q2.top()=='('){q2.pop();continue;}
                temp++;
            }
        }

        if(!q2.empty())valid[i]=0;
        if(valid[i])
        {
            cntn[temp]++;
        }

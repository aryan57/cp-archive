...
/*
    // tut used
    author : aryan57
    created : 07-May-2021 11:27:44 IST
*/
#include <bits/stdc++.h>
using namespace std;
...
void solve_LOG()
{
    ...
    segtree<int,binary_operation,identity_element> tree(a);

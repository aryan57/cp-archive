...
/*
    ...
    created : 22-November-2020 12:03:54 IST
*/
...
void solve()
{
    ...
    while(q--)
    {
        ...
        if(s[l]=='1' && l>0 && cnt1[l-1])
        {
            pfy;nl;
            continue;
        }

        if(s[l]=='0' && l>0 && cnt0[l-1])
        {
            pfy;nl;
            continue;
        }

        if(s[r]=='1' && cnt1[n-1]-cnt1[r]>0)
        {
            pfy;nl;
            // cout<<"**\n";
            continue;

/*
    ...
    created : 29-November-2020 10:00:28 IST
*/
...
signed main()
{
    ...
    F(bit,0,9)
    {
        ...
        F(i,1,n)
        {
            if(r1[bit][i])
            {
                if(r0[bit][i])both.pb({i,r1[bit][i]});
                else one.pb({i,r1[bit][i]});
            }
        }

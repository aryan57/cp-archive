...
void solve()
{
    ...
    int cur,curl=0,curr=(int)pow(2,m)-1;
    int mid=(curr-curl)/2;
    ...
    F(i,1,m-sz(ans))cout<<0;
    RF(i,sz(ans)-1,0)cout<<ans[i];
}
